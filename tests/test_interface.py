...
from xtbwheel.interface import (
    Calculator,
    Molecule,
    Param,
    Results,
...
from xtbwheel.libxtb import VERBOSITY_MINIMAL
...
def test_gfn2_xtb_3d():
    ...
    positions = np.array(
        [
            [9.77104501e-01, 1.24925555e-01, 8.22139769e00],
            [8.37995371e-01, 8.23489051e00, 3.74893761e00],
            [4.62693404e00, -2.45721089e00, 8.22052352e00],
            [4.62532610e00, 1.41051267e00, 5.97940016e00],
            [9.71618351e-01, 1.17570237e-01, 3.75065164e00],
            [-2.80917006e00, 6.94865315e00, 5.99166085e00],
            [4.06610161e00, 4.51252077e00, 6.46827038e-01],
            [2.76223056e-01, -8.50055887e-01, 2.06420987e00],
            [2.84806942e-01, 2.07039689e00, 8.22836360e00],
            [2.90284064e00, 8.22939158e00, 3.73820878e00],
            [6.69188274e00, -2.46191735e00, 8.22593771e00],
            [6.69035555e00, 1.41863696e00, 5.97712614e00],
            [7.73011343e00, 1.91963880e00, 6.45533278e-01],
            [3.94842571e00, 3.36121142e00, 5.97668593e00],
            [-3.49960564e00, 5.97197638e00, 7.67502785e00],
            [2.79250975e-01, 2.06298102e00, 3.73907675e00],
            [-3.50586965e00, 5.96534053e00, 4.31491171e00],
            [1.56432603e-01, 7.25773353e00, 2.06229892e00],
            [-4.98732693e-02, 6.88619344e00, 5.98746725e00],
            [-4.50657119e-03, -1.16906911e00, 5.98934273e00],
            [3.73678498e00, 1.55157272e-01, 8.27155126e00],
            [3.73119434e00, 1.47879860e-01, 3.69345547e00],
        ]
    )
    lattice = np.array(
        [
            [1.13437228e01, -1.84405404e-03, 1.33836685e-05],
            [-3.78300868e00, 1.06992286e01, -1.04202175e-03],
            [-3.78025723e00, -5.34955718e00, 9.26593601e00],
        ]
    )
...
def test_gfn1xtb_solvation():
    ...
    gradient = np.array(
        [
            ...
            [
                -0.014057002659599450,
                0.001307143355963449,
                -0.006896995523674975,
            ],
            ...
            [
                -0.001015432627909870,
                -0.003296949677104424,
                0.001316980539002961,
            ],
            [
                -0.006952278070976579,
                0.004741461728853791,
                -0.010835641525482725,
            ],
            [0.004676820346825542, 0.013884337727247118, -0.001369508087834928],
            [
                -0.008836453325485083,
                -0.008509582724068617,
                -0.004439799174447864,
            ],
            [0.014459308335089790, 0.005276511880967742, 0.004903442725946663],
            [
                -0.036094040309768836,
                -0.003785312815195147,
                0.006658677483987865,
            ],
            [0.008136405754401969, 0.004504379636843624, 0.003321663239613836],
            [
                0.008869982110786701,
                -0.011001116814485038,
                -0.001446882216395328,
            ],
            [0.016590179303752735, -0.004068517105666850, 0.002429055885660720],
            [
                -0.007907876155693029,
                -0.003802464713817357,
                -0.003873086023200218,
            ],
            [
                -0.000245758070628337,
                0.000875351650743832,
                -0.003291567698024252,
            ],
...
def test_gfn2xtb_solvation():
    ...
    gradient = np.array(
        [
            ...
            [
                -0.00021150434069988,
                -0.002620960429434571,
                -0.008691267383737740,
            ],
...
def test_gfn2xtb_orbitals():
    ...
    assert (
        approx(this_coefficients[16], thr) == +coefficients17
        or approx(this_coefficients[16], thr) == -coefficients17
    )
    assert (
        approx(this_coefficients[17], thr) == +coefficients18
